defmodule SigninappEx.Config.ConfigHolder do
  use GenServer
  alias SigninappEx.Config.AppConfig
  @table_name :signinapp_ex_config
  ...
  defp load_additional_properties(%AppConfig{} = config) do
    Application.get_env(:signinapp_ex, :config_loaders, [])
...
defmodule SigninappEx.Config.ConfigHolder.PropertiesLoaderBehaviour do
  alias SigninappEx.Config.AppConfig
